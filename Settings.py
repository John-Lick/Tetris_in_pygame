...
I_CHECKS = {
    (0, 1) : [vec(-1, 0), vec(-1, 0), vec(0, 2),  vec(-1, 2)],
    (1, 0) : [vec(1, 0),  vec(1, 0),   vec(0, -2), vec(1, -2)],
    (1, 2) : [vec(1, 0),  vec(1, 0),   vec(0, -2), vec(1, -2)],
    (2, 1) : [vec(-1, 0), vec(-1, 0), vec(0, 2),  vec(-1, 2)],
    (2, 3) : [vec(1, 0),  vec(1, 0),  vec(0, 2),  vec(-1, 2)],
    (3, 2) : [vec(-1, 0), vec(-1, 0),  vec(0, -2), vec(1, -2)],
    (3, 0) : [vec(-1, 0), vec(-1, 0),  vec(0, -2), vec(1, -2)],
    (0, 3) : [vec(1, 0),  vec(1, 0),  vec(0, 2),  vec(-1, 2)]
}
